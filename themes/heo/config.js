const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '欢迎来到Ginon的博客', url: 'https://x.com/Ginon23650' },
    { title: 'Learn Encryption · Enjoy Blockchain · Share Decentralization', url: 'https://x.com/Ginon23650' }
  ],
  ...
  HEO_HERO_TITLE_LINK: 'https://coinmarketcap.com/',
  // 英雄区遮罩文字
  HEO_HERO_COVER_TITLE: '随便逛逛',

  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '文章精选', url: '/tag/必看精选' },
  HEO_HERO_CATEGORY_2: { title: '热门项目', url: 'https://www.rootdata.com/' },
  ...
  HEO_INFO_CARD_URL3: 'https://ginon.vercel.app',
