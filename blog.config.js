...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ginon', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '撸点小羊毛的🐂🐎🧑‍💻', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ginon-notion.vercel.app', // 网站地址
